...
@Schema(description = "Dados da enquete recém-criada")
public record CreatePollOutput(
                @Schema(description = "ID único da enquete criada", example = "123e4567-e89b-12d3-a456-426614174000") String pollId,
                ...
                @Schema(description = "Status atual da enquete", example = "SCHEDULED", allowableValues = {
                ...
                @Schema(description = "Lista de opções da enquete") List<PollOptionOutput> options){
